...
func InstallIPA(_ itemID: UUID, queueManager: QueueManager, completion: @escaping (FunctionStatus) -> Void) {
    ...
    if !FileManager.default.fileExists(atPath: IPAPathURL.path) {
        ...
        return
    } else if let trollStoreApp = SBFApplication(applicationBundleIdentifier: "com.opa334.TrollStoreLite") ?? SBFApplication(applicationBundleIdentifier: "com.opa334.TrollStore") {
